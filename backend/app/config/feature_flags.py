...
_DEFAULT_FLAG_STATE: Dict["FeatureFlag", bool] = {
    ...
    FeatureFlag.MAJOR_DEEP_LEARNING_VISUAL_INSPECTION: False,
    FeatureFlag.MAJOR_ML_RISK_PREDICTION: False,
    FeatureFlag.MAJOR_IOT_ENVIRONMENTAL_ANALYTICS: False,
...
class FeatureFlagSettings(BaseSettings):
    ...
    MAJOR_DEEP_LEARNING_VISUAL_INSPECTION: bool = False
    MAJOR_ML_RISK_PREDICTION: bool = False
    MAJOR_IOT_ENVIRONMENTAL_ANALYTICS: bool = False
